...
function createContainer(Component) {
  ...
  var Container = function (_React$Component) {
    ...
    (0, _createClass3.default)(Container, [{
      ...
      value: function setSubscribeData(nextSubscribeQueries) {
      ...
      value: function render() {
        ...
        if (!hasResults) return _reactNative2.default.createElement(_Loading2.default, null);
        ...
        return _reactNative2.default.createElement(Component, props);
      }
    }]);
    return Container;
  ...
  Container.propTypes = {
    hasResults: _reactNative.PropTypes.bool,
    onFetch: _reactNative.PropTypes.func
  };
